...
class EventController extends Controller
{
    ...
    {
        return view('admincp.sukien.index');
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate(
            [
                'tensukien' => 'required|unique:ticket|max:255',
                'slug_sukien' => 'required|unique:ticket|max:255',
        ...
        $event = new Event();
        $event->tenve = $data['tensukien'];
        $event->slug_ve = $data['slug_sukien'];
